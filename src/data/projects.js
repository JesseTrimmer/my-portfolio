...
const projects = [
  {
    ...
    images: [`${base}images/cinemavault-library.png`, `${base}images/cinemavault-stats.png`],
    links: [
  ...
  },
  {
    ...
    images: [`${base}images/weather-app.png`],
    links: [
  ...
  },
  {
    ...
    images: [`${base}images/overhill-gardens.png`],
    links: [
  ...
  },
  {
    ...
    images: [`${base}images/frog-jump.png`],
    links: [
  ...
  },
  {
    ...
    images: [`${base}images/clearwater-budget.png`],
    links: [
      { label: 'GitHub', url: 'https://github.com/JesseTrimmer', external: true },
    ],
  },
  {
    ...
    images: [`${base}images/my-tasks.png`],
    links: [
      { label: 'GitHub', url: 'https://github.com/JesseTrimmer', external: true },
    ],
  },
